...
// _kTitleText = [aTitle copy];
 ...
 cell.textLabel.text = [[_kDropDownOption objectAtIndex:row] st_stringForKey:@"name"];
     cell.textLabel.textColor=[UIColor colorWithRed:34.0/255.0 green:34.0/255.0 blue:34.0/255.0 alpha:1.0];
     [cell.textLabel setFont:[UIFont fontWithName:@"Caviar Dreams Bold" size:12]];
 return cell;
 }
