...
public class SeeAllMutualConnectionListAdapter extends BaseAdapter {
    ...
    public SeeAllMutualConnectionListAdapter(List<ProfileDetailsConnectionList> content_list, Context context )
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        viewholder.rel_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ProfileDetailsConnectionList col_data=mDataArray.get(position);
