...
public class AttendeesListAdapter extends RecyclerView.Adapter<AttendeesListAdapter.MyViewHolder> {

    MyViewHolder holder;
    Context context;
    ArrayList<MeetupDetailsAttendeesList> _attediesList;
    Bitmap icon;
    NestedScrollView mScroll;

    public AttendeesListAdapter(Context context, ArrayList<MeetupDetailsAttendeesList> _attediesList,
                                NestedScrollView mScroll)
    {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.txt_name.setText(_attediesList.get(position).getName().toString());
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MeetupDetailsAttendeesList meetObj=_attediesList.get(getAdapterPosition());
                    Bundle arguments = new Bundle();
                    arguments.putString("tag", "");
                    arguments.putString("interest", "");
                    arguments.putInt("id", Integer.parseInt(meetObj.getUserId()));
