...
public class UpcomingEventAdapter extends BaseAdapter {
    ...
    Context context;
    ArrayList<DashboardNextMeetup> _data;
    Typeface typeFaceOpenSansBold, typeFaceOpenSansReg;

    public UpcomingEventAdapter(Context context, ArrayList<DashboardNextMeetup> cityHostelListRequests){
        if(context!=null) {
            this.context = context;
            this._data = cityHostelListRequests;
    ...
    public class ViewHolder{
        TextView tv_meetup_title, total_users_added, text_added,text_date,text_time;
        ImageView img_profile;
        public ViewHolder(View v)
        {
            tv_meetup_title=(TextView)v.findViewById(R.id.tv_meetup_title);
            total_users_added=(TextView)v.findViewById(R.id.total_users_added);
            ...
            total_users_added.setTypeface(typeFaceOpenSansReg);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.total_users_added.setText(String.valueOf(_data.get(position).getPeopleAdd()));

        Constants.setSquareImage(holder.img_profile,_data.get(position).getMeetupCreatorPic(),context);

        if(_data.get(position).getPeopleAdd()<=1)
        ...
        holder.img_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DashboardNextMeetup col_data=_data.get(position);
