...
public class MyMeetupAdapterList extends RecyclerView.Adapter<MyMeetupAdapterList.MyViewHolder>
    ...
    public MyMeetupAdapterList(List<AllMeetupData> meetList, Context ctx, boolean ismyMeetups, OnClickCallBack mCallback) {
...
//                    textView.setText("3232");
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_my_meetup_fragment, parent, false);
...
//            holder.txt_others_count.setText("and "+meet_list.get(position).getAttendee().size()+" others");
    ...
    public class CustomFilter extends Filter {
        private MyMeetupAdapterList mAdapter;
        private CustomFilter(MyMeetupAdapterList mAdapter) {
            super();
