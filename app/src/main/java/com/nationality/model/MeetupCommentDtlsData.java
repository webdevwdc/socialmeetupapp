...
public class MeetupCommentDtlsData {
    ...
    @Expose
    private List<MeetupCommentDtlsRespondChild> respondChild = null;
    ...
    public List<MeetupCommentDtlsRespondChild> getRespondChild() {
        return respondChild;
    }

    public void setRespondChild(List<MeetupCommentDtlsRespondChild> respondChild) {
