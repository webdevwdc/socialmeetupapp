...
import com.nationality.adapter.MyBulletinListAdapter;
 ...
 * Use the {@link FragmentMyBulletin#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentMyBulletin extends Fragment implements View.OnClickListener, RetrofitListener,OnClickCallBack{
...
//    @Bind(R.id.my_recycler_view)
    ...
    public static FragmentMyBulletin newInstance(String param1, String param2) {
        FragmentMyBulletin fragment = new FragmentMyBulletin();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_my_bulletin, container, false);
        ...
        getMyBulletinList(Constants.getUserId(getActivity()));

        return view;
    }

    private void getMyBulletinList(int user_id) {
        rest.makeHttpRequest(rest.retrofit.create(RestHandler.RestInterface.class).
                getMyBulletinList(user_id),"getMyBulletinData");
        pDialog.show();
    }
    ...
    public void onSuccess(Call call, Response response, String method) {
        ...
        if(response!=null && response.code()==200){
            ...
            if (method.equalsIgnoreCase("getMyBulletinData")) {
                BulletinMyListRequest req_Obj = (BulletinMyListRequest) response.body();
                if(!req_Obj.getResult().getError()) {
                    recycler_view_bulletins.setAdapter(new MyBulletinListAdapter(req_Obj.getResult().getData(), getActivity(),this));

                    if(req_Obj.getResult().getData()!=null &&
                            req_Obj.getResult().getData().size()==0){
                        recycler_view_bulletins.setVisibility(View.GONE);
                        tv_no_msg.setVisibility(View.VISIBLE);
                    }
                    else{
...
//                    Toast.makeText(getActivity(),"No Bulletin created yet..",Toast.LENGTH_LONG).show();
